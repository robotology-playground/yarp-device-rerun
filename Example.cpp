...
YARP_LOG_COMPONENT(RERUN_EXAMPLE, "yarp.device.example")

bool Example::configure(yarp::os::ResourceFinder& rf)
{
    yCInfo(RERUN_EXAMPLE) << "Configuring Rerun visualizer...";
...
double Example::getPeriod()
{
    return 0.1;
}

bool Example::updateModule() 
{
...
void Example::loadURDF(rerun::RecordingStream& rr) 
{
