...
// Generated on: Thu Mar 19 10:35:47 2026
...
* |:----------:|:----------------------------:|:--------------:|:-----:|:-------------------:|:--------:|:----------------------------------------------------------------:|:-----:|
* | -          | yarpRobotName                | string         | -     | -                   | 1        | It could be `ergoCub` or `iCub`                                  | -     |
...
public:
    ...
    const std::string m_yarpRobotName_defaultValue = {""};
    ...
    std::string m_yarpRobotName = {}; //This default value is autogenerated. It is highly recommended to provide a suggested value also for mandatory parameters.
